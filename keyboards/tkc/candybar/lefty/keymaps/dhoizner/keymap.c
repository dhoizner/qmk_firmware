...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
[_BL] = LAYOUT(
  KC_P7  , KC_P8, KC_P9  , KC_PAST, KC_ESC , KC_Q   , KC_W   , KC_F, KC_P   , KC_B  , KC_J, KC_L   , KC_U   , KC_Y   , KC_QUOT   , KC_DEL , KC_BSPC , \
  KC_P4  , KC_P5, KC_P6  , KC_PMNS, KC_TAB , KC_A   , KC_R   , KC_S, KC_T   , KC_G  , KC_M, KC_N   , KC_E   , KC_I   , KC_O,          KC_ENT  , \
  KC_P1  , KC_P2, KC_P3  , KC_PPLS, KC_LSFT,          KC_Z   , KC_X, KC_C   , KC_D  , KC_V, KC_K   , KC_H   , KC_COMM, KC_DOT , KC_UP   ,KC_RSFT , \
  MO(_FL), LT(_FL, KC_P0), KC_PDOT, KC_PENT, KC_LCTL, KC_LGUI, KC_LALT,                KC_BSPC,       KC_NO , KC_SPC, KC_APP , KC_LEFT, KC_DOWN, KC_RGHT),
